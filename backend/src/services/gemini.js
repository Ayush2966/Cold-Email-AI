...
function buildPrompt({ senderName, senderEmail, phone, positionTitle, jdText, resumeText }) {
...
2) The email body in plain text, 150–220 words, personalized, no fluff, one clear call-to-action.
